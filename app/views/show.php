      ...
      <table class="min-w-full border border-gray-700 border-collapse bg-[#212631] text-white">
        <thead class="bg-[#1b1f29]">
          <tr>
            ...
            <th class="px-4 py-3 text-left uppercase text-xs sm:text-sm font-semibold border-r border-gray-700">Status</th>
            ...
            <tr class="hover:bg-[#2a2f3a] transition">
              ...
              <td class="px-4 py-3 border-r border-gray-700">
                <?php if ($user['status'] === 'Active'): ?>
                  <span class="px-3 py-1 rounded-md bg-green-600 text-white font-semibold">
                    Active
                  </span>
                <?php elseif ($user['status'] === 'Inactive'): ?>
                  <span class="px-3 py-1 rounded-md bg-red-600 text-white font-semibold">
                    Inactive
                  </span>
                <?php else: ?>
                  <span class="px-3 py-1 rounded-md bg-gray-500 text-white font-semibold">
                    N/A
                  </span>
                <?php endif; ?>
              </td>
